...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(StringUtils.isBlank(appDesc), ErrorCode.PARAMS_ERROR, "应用名称不能为空");
            ReviewStatusEnum appTypeEnum = ReviewStatusEnum.getEnumByValue(appType);
            ...
            ThrowUtils.throwIf(scoringStrategyEnum == null, ErrorCode.PARAMS_ERROR, "计分策略非法");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
        ...
        if (reviewStatus!=null){
            ...
            ThrowUtils.throwIf(enumByValue == null, ErrorCode.PARAMS_ERROR, "审核状态非法");
